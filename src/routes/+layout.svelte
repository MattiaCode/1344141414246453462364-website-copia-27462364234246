...
<!-- Navbar -->
<nav class="fixed top-0 left-0 right-0 z-50 bg-white/70 dark:bg-gray-950/70 backdrop-blur-xl">
		...
		<div id="mobile-menu" class="hidden md:hidden mt-3 pb-2">
			<div class="bg-gray-100/80 dark:bg-gray-800/80 rounded-2xl p-2 backdrop-blur-sm">
				{#each navItems as item}
					...
					>
						<svelte:component this={item.icon} size={18} class="text-gray-700 dark:text-gray-300" />
	...
	<div class="max-w-7xl mx-auto px-4 sm:px-6 py-12">
		<div class="flex flex-col md:flex-row justify-between items-center gap-6">
			...
			<div class="flex items-center gap-4">
				...
				<a href="https://twitter.com" target="_blank" rel="noopener noreferrer" class="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors">
					<svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
